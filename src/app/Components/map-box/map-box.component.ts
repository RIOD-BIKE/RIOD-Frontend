...
export class MapBoxComponent implements OnInit {
  ...
  private pointFetch():Promise<any>{
    ...
    this.mapDataFetchService.retrieveClusters().subscribe((value) => { console.log("CLUSTER"+value.entries);
    ...
    this.mapDataFetchService.retrieveAssemblyPoints().subscribe((value) => { console.log("APS"+value.values);
